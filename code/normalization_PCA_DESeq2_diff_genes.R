...
raw_counts_final <- read.csv("~/Schwob/RNAseq_HBCactivation/raw_counts_newalignment.csv", row.names=1)
...
ggsave(filename="ActivationPaper_PCA.png", plot=finalPCA, device="png",
